...
- It names the four kickoff outputs by their actual paths: `docs/stack-guide.md`,
  `CLAUDE.md`, `tasks.md`, and `docs/constitution-seed.md`.
...
Fail if the language question is a single "which language?". Fail if the four
output files are not named. Fail if questions arrive without recommendations.
